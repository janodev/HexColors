...
```
Or if you need a minimal logging tool to produce the logs you saw at the top, I included [one](https://github.com/j4n0/HexColors/blob/master/other/Example/Example/Logger.swift) in the example project.
